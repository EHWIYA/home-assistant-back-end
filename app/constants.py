...
ENTITY_AC_SCRIPT_SMART_ON = "script.hwiya_ac_smart_on"
ENTITY_AC_SCRIPT_TURN_OFF = "script.hwiya_ac_turn_off"
# PWA/API 수동 OFF — 온도·가동 게이트 없음 (자동용 turn_off 와 분리)
ENTITY_AC_SCRIPT_MANUAL_TURN_OFF = "script.hwiya_ac_manual_turn_off"
ENTITY_AC_SOFT_OFF = "binary_sensor.hwiya_ac_soft_off"
ENTITY_AC_PLUG_CUT_SAFE = "binary_sensor.hwiya_ac_plug_cut_safe"
AC_REMOTE_DEVICE = "ac"
